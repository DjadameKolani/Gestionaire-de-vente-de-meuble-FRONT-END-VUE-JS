...
const BASE_URL = 'http://localhost:8080' // ✅ URL du backend
...
function getImageUrl(produit) {
  if (produit.imageUrl) {
    return `${BASE_URL}${produit.imageUrl}` // ex: http://localhost:8080/uploads/abc.jpg
  }
  return '/assets/images/product-1.png' // image par défaut
}
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
          ...
          <p><router-link :to="{ name: 'Shop' }" class="btn">Explore</router-link></p>
        </div>
        ...
        <template v-else>
          <div
            v-for="produit in produits.slice(0, 3)"
            :key="produit.id"
          ...
          >
            ...
            >
              ...
              <strong class="product-price">{{ produit.prix }} FCFA</strong>
                          ...
                          <div class="col-lg-8 mx-auto">
                            <div class="testimonial-block text-center">
                              <blockquote class="mb-5">
                                <p>
                                  &ldquo;Donec facilisis quam ut purus rutrum lobortis. Donec vitae
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                  <div class="post-entry">
                    <a href="#" class="post-thumbnail"
                      ><img src="/assets/images/post-1.jpg" alt="Image" class="img-fluid"
                    /></a>
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                  <div class="post-entry">
                    <a href="#" class="post-thumbnail"
                      ><img src="/assets/images/post-2.jpg" alt="Image" class="img-fluid"
                    /></a>
                    <div class="post-content-entry">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                  <div class="post-entry">
                    <a href="#" class="post-thumbnail"
                      ><img src="/assets/images/post-3.jpg" alt="Image" class="img-fluid"
                    /></a>
                    <div class="post-content-entry">
